...
export default function NotificationPopover({ notifications, onMarkRead, onClose }: NotificationPopoverProps) {
  ...
  return (
    <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-slate-800 border border-slate-700/50 rounded-3xl shadow-2xl shadow-black/50 z-50 overflow-hidden flex flex-col max-h-[500px]">
      {/* Header */}
      <div className="px-6 py-4 border-b border-slate-700/50 flex items-center justify-between bg-slate-800 sticky top-0">
        <div>
