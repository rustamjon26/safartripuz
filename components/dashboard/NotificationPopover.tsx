...
export default function NotificationPopover({ notifications, onMarkRead, onClose }: NotificationPopoverProps) {
  ...
  return (
    <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white border border-gray-200 rounded-3xl shadow-2xl shadow-gray-900/10 z-50 overflow-hidden flex flex-col max-h-[500px]">
      <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-white sticky top-0">
        <div>
          <h3 className="font-black text-gray-900 leading-none">Bildirishnomalar</h3>
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-gray-100">
        {notifications.length === 0 ? (
          <div className="py-12 flex flex-col items-center justify-center text-center px-6">
            ...
            <p className="text-sm font-bold text-gray-500">Hozircha xabarlar yo&apos;q</p>
          </div>
        ) : (
          notifications.map((n) => (
            <div
              ...
              className={`p-5 flex gap-4 transition-colors cursor-pointer group ${
                !n.readAt ? "bg-blue-50/50 hover:bg-blue-50" : "hover:bg-gray-50"
              }`}
            >
              <div
      ...
      <div className="p-4 bg-gray-50 border-t border-gray-100 text-center">
        <button type="button" className="text-xs font-black text-gray-500 hover:text-gray-900 transition-colors">
