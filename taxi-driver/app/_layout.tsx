...
// This prevents the white flash between splash and the first JS screen
// on Android, where the auto-hide can fire before we're ready.
...
const styles = StyleSheet.create({
  ...
  errorSafe: { flex: 1, backgroundColor: COLORS.lightGray },
  errorContainer: {
    flex: 1,
    alignItems: "center",
    justifyContent: "center",
