...
export const translations = {
  uz: {
    nav: {
      ...
      invoices: "Invoys",
      front: "Operatsiya (Front)",
      crm: "CRM & Moliya",
      hr_moddiy: "Jamoa & Ombor",
      quality: "Sifat & Marketing",
    },
    shell: {
      brand: "SafarTrip Partner",
      tagline: "Mehmonxona boshqaruvi",
      settings: "Sozlamalar",
      check_in: "Check-in",
      manager_fallback: "Menejer",
    },
    dashboard: {
      ...
      room_available: "Bo'sh xonalar",
      room_occupied: "Band xonalar",
      room_cleaning: "Tozalashda",
      room_maintenance: "Ta'mirlashda",
      room_blocked: "Bloklangan",
      occupancy_rate: "Bandlik darajasi",
      check_ins_today: "Bugungi check-in",
      check_outs_today: "Bugungi check-out",
      new_bookings_today: "Yangi bronlar",
      revenue_today: "Bugungi daromad",
      revenue_month: "Shu oylik daromad",
      recent_bookings: "So'nggi bronlar",
      stats_load_error: "Ma'lumot yuklanmadi, qayta urinish",
      share_total: "{pct}% jami",
      col_guest: "Mehmon",
      col_room: "Xona",
      col_type: "Tur",
      ...
      col_status: "Holat",
      col_price: "Narx",
      view_rooms_link: "{count} ta xonani ko'rish →",
      cleaning_bulk_action: "Barchasini available ga o'tkazish",
      cleaning_bulk_confirm: "{count} ta cleaning xonani available ga o'tkazasizmi?",
      cleaning_bulk_success: "{count} ta xona available ga o'tkazildi",
      cleaning_bulk_empty: "Cleaning holatidagi xona topilmadi",
      occupied_short: "Band",
    ...
    hr: {
      title: "Vakolatlar va kirish",
      subtitle: "Xodimlarga rol bering, email/parol bilan PMS ga kirish oching",
      total_team: "Jami jamoa",
      active_staff: "Faol xodimlar",
      departments: "Vakolatlar",
      new_notification: "Eslatma",
      add_staff: "Vakolat berish",
      table: {
         name: "Xodim",
         role: "Vakolat",
         contact: "Login (email)",
      ...
      modal: {
         add_title: "Yangi vakolat / xodim",
         edit_title: "Vakolatni tahrirlash",
         first_name: "Ism *",
         last_name: "Familiya",
         email: "Email (login) *",
         phone: "Telefon",
         role: "Vakolat / rol",
         password: "Parol *",
         password_edit: "Yangi parol (ixtiyoriy)",
         password_hint: "Kamida 8 belgi. Bo‘sh qoldirsangiz, vaqtinchalik parol yaratiladi.",
         password_edit_hint: "Bo‘sh qoldirsangiz parol o‘zgarmaydi.",
         generate: "Tasodifiy parol",
         cancel: "Bekor qilish",
         save: "Saqlash",
         add_btn: "Yaratish va ochish",
         login_ready: "Kirish ma'lumotlari tayyor!",
         login_desc: "Xodim shu email va parol bilan /login orqali PMS ga kiradi:",
         temp_pass: "Parol",
         got_it: "Tushunarli",
         warning: "Parolni xodimga xavfsiz uzating. Keyin u profilidan o‘zgartirishi mumkin.",
         confirm_delete: "Ushbu xodim vakolatini olib tashlaysizmi?",
         delete_success: "Vakolat olib tashlandi",
         add_success: "Xodim qo‘shildi — login ochildi",
         update_success: "Vakolat yangilandi",
    ...
    housekeeping: {
      ...
      subtitle_manager: "Tozalash va operatsiyalar dispatcher",
      ...
      stats: {
        ...
        urgent_count: "{count} ta Shoshilinch",
        in_progress: "Tozalanmoqda",
        in_progress_badge: "Aktiv",
        cleaned: "Tozalangan",
        cleaned_badge: "Ok",
        queued: "Navbatda",
        queued_badge: "Reja",
      ...
      dispatcher: {
        title: "Tozalash va Operatsiyalar Dispatcher",
        col_room: "Xona / Tur",
        ...
        status_progress: "Tozalanmoqda",
        status_done: "Tozalangan",
        status_verified: "Tekshirilmoqda",
      },
      staff_panel: {
        title: "Xodimlar holati",
        total: "{count} Jami",
        free: "Bo'sh",
        load: "Yuklama: {current}/{max}",
        room_task: "Xona #{room}",
      ...
      inventory_panel: {
        ...
        low_alert: "Kamomad aniqlandi! Zaxira minimal darajadan tushib ketdi.",
    ...
    rooms: {
      ...
      bulk: {
        ...
        rooms_selected: "{count} ta xona tanlandi",
        status_label: "Status",
        status_placeholder: "Holat tanlang",
        status_required: "Holat tanlang",
        note_placeholder: "Sabab kiriting (ixtiyoriy)",
        apply: "O'zgartirish",
        success: "{count} ta xona {status} ga o'tkazildi",
    ...
    homestay: {
      ...
      dashboard: {
        title: "Uy Mehmonxonasi Paneli",
        total_earnings: "Jami daromad",
        active_listings: "Faol listinglar",
        pending_bookings: "Kutilayotgan bronlar",
        recent_bookings: "So'nggi bronlar",
        my_listings: "Mening listinglarim",
        add_listing: "Listing qo'shish",
        view_all: "Hammasini ko'rish",
        no_listings: "Hali listing yo'q",
        no_bookings: "Hali bronlar yo'q",
        onboarding_title: "Birinchi listingingizni qo'shing",
        onboarding_desc: "Uy mehmonxonangizni SafarTrip da e'lon qiling",
      },
      listing: {
        new: "Yangi listing",
        edit: "Tahrirlash",
        ...
        city: "Shahar",
        region: "Viloyat",
        price_per_night: "1 tun narxi (so'm)",
        max_guests: "Maksimal mehmonlar",
        rooms: "Xonalar soni",
        beds: "Karavotlar soni",
        bathrooms: "Hammomlar soni",
        location: "Lokatsiya (majburiy)",
        images: "Rasmlar",
        amenities: "Qulayliklar",
        save: "O'zgarishlarni saqlash",
        create: "Listing yaratish",
        cancel: "Bekor qilish",
        created: "Listing muvaffaqiyatli yaratildi",
        updated: "Listing muvaffaqiyatli yangilandi",
        not_found: "Listing topilmadi",
        per_night: "/ tun",
        guests: "mehmon",
      },
      amenities: {
      ...
      calendar: {
        title: "Mavjudlik kalendari",
        block: "Sanalarni bloklash",
  ...
  en: {
    ...
    dashboard: {
      ...
      room_available: "Available rooms",
      room_occupied: "Occupied rooms",
      room_cleaning: "Cleaning",
      room_maintenance: "Maintenance",
      room_blocked: "Blocked",
      occupancy_rate: "Occupancy rate",
      check_ins_today: "Today's check-ins",
      check_outs_today: "Today's check-outs",
      new_bookings_today: "New bookings",
      revenue_today: "Today's revenue",
      revenue_month: "This month's revenue",
      recent_bookings: "Recent bookings",
      stats_load_error: "Failed to load data, try again",
      share_total: "{pct}% of total",
      col_guest: "Guest",
      col_room: "Room",
      col_type: "Type",
      col_check_in: "Check-in",
      ...
      col_status: "Status",
      col_price: "Price",
      view_rooms_link: "View {count} rooms →",
      cleaning_bulk_action: "Mark all as available",
      cleaning_bulk_confirm: "Move {count} cleaning rooms to available?",
      cleaning_bulk_success: "{count} rooms moved to available",
      cleaning_bulk_empty: "No cleaning rooms found",
    ...
    hr: {
      ...
      subtitle: "Assign roles and open PMS login with email/password",
      total_team: "Team size",
      active_staff: "Active staff",
      departments: "Roles",
      new_notification: "Note",
      add_staff: "Grant access",
      table: {
         name: "Staff",
         role: "Permission",
         contact: "Login (email)",
      ...
      modal: {
         ...
         password: "Password *",
         password_edit: "New password (optional)",
         password_hint: "Min 8 chars. Leave empty to auto-generate a temporary password.",
         password_edit_hint: "Leave empty to keep the current password.",
         generate: "Random password",
         cancel: "Cancel",
         save: "Save",
         add_btn: "Create & open login",
         login_ready: "Login credentials ready!",
         login_desc: "Staff can sign in at /login with this email and password:",
         temp_pass: "Password",
         got_it: "Done",
         warning: "Share the password securely. They can change it later in profile.",
         confirm_delete: "Remove this staff access?",
         delete_success: "Access removed",
         add_success: "Staff added — login opened",
         update_success: "Access updated",
    ...
    housekeeping: {
      ...
      subtitle_manager: "Cleaning & operations dispatcher",
      ...
      dispatcher: {
        title: "Cleaning & Operations Dispatcher",
        col_room: "Room / Type",
        ...
        status_progress: "Cleaning",
        status_done: "Cleaned",
        status_verified: "Inspecting",
      },
      staff_panel: {
        title: "Staff status",
        total: "{count} Total",
        free: "Free",
        load: "Load: {current}/{max}",
        room_task: "Room #{room}",
        see_all: "See all",
      },
      inventory_panel: {
        ...
        low_alert: "Shortage detected! Stock fell below minimum.",
        order: "Place order",
    ...
    rooms: {
      ...
      bulk: {
        ...
        rooms_selected: "{count} rooms selected",
        status_label: "Status",
        status_placeholder: "Choose status",
        status_required: "Please choose a status",
        note_placeholder: "Enter reason (optional)",
        apply: "Apply",
        success: "{count} rooms changed to {status}",
    ...
    homestay: {
      ...
      dashboard: {
        ...
        onboarding_title: "Add your first listing",
        onboarding_desc: "List your home stay on SafarTrip",
      },
      listing: {
        new: "New listing",
        edit: "Edit",
