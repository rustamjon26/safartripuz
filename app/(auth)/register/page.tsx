...
export default function RegisterPage() {
  ...
  const schema = useMemo(
    () =>
      z
        .object({
          first_name: z.string().trim().min(1, "Ism majburiy"),
          last_name: z.string().trim().min(1, "Familiya majburiy"),
          ...
          password: z
            ...
            .regex(
              /^(?=.*[A-Za-z])(?=.*\d).+$/,
              "Parolda kamida 1 ta harf va 1 ta raqam bo‘lsin",
            ),
  ...
  return (
    <div className="w-full max-w-[420px] rounded-2xl border border-slate-200 bg-white p-5 shadow-lg sm:p-6">
      ...
      <button
        ...
        disabled={busy}
        onClick={() =>
          toast.message("Google register hozircha simulyatsiya qilindi")
        }
        className={[
