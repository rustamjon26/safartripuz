...
import {
  ...
  generateReportExcel,
} from "@/lib/hotel/reports/generateReportExcel";
...
export async function GET(
  ...
  try {
    ...
    const excelBuffer = generateReportExcel({
      hotelName: hotel.name,
      report,
    });

    const filename = buildReportExcelFilename(parsed.data.end);
    ...
    console.error("Hotel reports Excel export error:", e);
